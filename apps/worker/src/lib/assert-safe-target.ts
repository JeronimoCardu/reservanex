// Safety guard for one-off dev/ops scripts (seed, demo, register-whatsapp, link-user,
// validate-*) that mutate data using the service-role key.
//
...
//
// Call assertSafeSupabaseTarget() as the first statement in main(), before creating any
// Supabase client or touching the database. It never prints the service-role key.
