...
import { getPaymentConfigAction }   from '@/actions/tenant-settings'
import { PaymentSettingsForm }      from './payment-settings-form'
import { cn }                       from '@/lib/utils'

export const metadata: Metadata = { title: 'Pagos — Configuración — ReservaNex' }
    ...
    <div className="flex flex-col overflow-hidden h-full">
          ...
          {TABS.filter(t => !t.ownerOnly || ctx.role === 'owner').map(t => (
            <Link
              ...
              className={cn(
                ...
                t.href === '/dashboard/settings/payments'
      ...
      <div className="border-b bg-background px-6 py-4">
        ...
        <p className="text-xs text-muted-foreground">
          Datos bancarios y mensajes relacionados con el cobro de reservas.
        </p>
      </div>
